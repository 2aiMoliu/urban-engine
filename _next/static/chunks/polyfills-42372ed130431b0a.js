!(function () {
    ...
    var W = n,
        ...
        lt = function (t) {
            return (
                "Symbol(" + (void 0 === t ? "" : t) + ")_" + ft(++st + ct, 36)
            );
        },
        ht = i.Symbol,
        pt = nt("wks"),
        ...
        Fe =
            u && !Pt
                ...
                : function (t, e) {
                      kt(t);
                      for (
                          var r, n = k(e), o = _e(e), i = o.length, a = 0;
                          i > a;
                      )
                          Ct.f(t, (r = o[a++]), n[r]);
                      return t;
            ...
            ("__proto__" in {}
                ? (function () {
                      var t,
                          ...
                          r = {};
                      try {
                          ((t = ln(Object.prototype, "__proto__", "set"))(
                              r,
                              [],
                          ),
        ...
        Wn = function (t) {
            ...
            if (!p || (this === zn && Nn(p)))
                ...
                for (
                    ...
                    ((h = i ? Mn(c, o, [s.value, v], !0) : s.value),
                        Cn(u, v, h));
            return ((u.length = v), u);
        },
        qn = dt("iterator"),
            ...
            if (
                ...
                (g ||
                    (((f = e(function (t, e) {
                        ...
                        var r = Io(new s(), t, f);
                        return (
                            P(e) || Ao(e, r[u], { that: r, AS_ENTRIES: n }),
                            r
                        );
                    })).prototype = c),
                    (c.constructor = f)),
    ...
    var ci = function (t, e, r) {
            for (
                var n, o, i = r ? t : t.iterator, a = t.next;
                !(n = f(a, i)).done;
            )
    ...
    u &&
        a(function () {
            ...
            return (
                Object.getOwnPropertyDescriptor(nc, "flags").get.call(e) !==
                    n || r !== n
            );
        }) &&
    ...
    var el = dt("iterator"),
        ...
        ol = function (t) {
            return (function (t) {
                return (
                    M(t) && "number" == typeof t.size && T(t.has) && T(t.keys)
                );
            })(t)
                ? t
                : (function (t) {
    ...
    (H ||
        ((jl = function () {
            ...
            return (
                u && zl && ql(Al, e, { configurable: !0, set: r }),
                Hl(e, t)
            );
        }),
    ...
    if (u && T(yh) && (!("description" in mh) || void 0 !== yh().description)) {
        ...
        var Sh =
                ...
                String(yh("description detection")),
            Eh = b(mh.valueOf),
            Oh = b(mh.toString),
            xh = /^Symbol\((.*)\)[^)]+$/,
            Rh = b("".replace),
    ...
    wv.prototype = {
        ...
        parseObject: function (t) {
            ...
            if (c)
                ...
                for (var l in t) ut(t, l) && rv(s, { key: l, value: Wr(t[l]) });
        },
        parseQuery: function (t) {
            if (t)
                for (
                    var e, r, n = this.entries, o = av(t, "&"), i = 0;
                    i < o.length;
                )
                    (e = o[i++]).length &&
                        ((r = av(e, "=")),
    ...
    if (
        ...
        an(Sv, Bp),
        Ce(
            { global: !0, constructor: !0, forced: !Mp },
            { URLSearchParams: Sv },
        ),
        !Mp && T(Kp))
    ) {
    ...
    if (Vm)
        var Ym = [
            ...
            Xm =
                ...
                function (t) {
                    return (
                        t && Ym.indexOf(Object.prototype.toString.call(t)) > -1
                    );
                };
    function Jm(t) {
        if (
